...
class CommentAdmin(admin.ModelAdmin):
    ...
    def content_preview(self,obj):
        return  obj.post[:50] + "..." if len(obj.content) > 50 else obj.content
    ...
    make_active.short_description = 'Make selected comments as active'


    def make_inactive(self, request, queryset):
        updated = queryset.update(is_active=False)
        self.message_user(request, f'{updated} comments were marked as inactive.')
    make_inactive.short_description = 'Make selected comments as inactive'